...
class Post1sControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create post1" do
    assert_difference('Post1.count') do
      post post1s_url, params: { post1: { description: @post1.description, lastlocation: @post1.lastlocation, lostdate: @post1.lostdate, title: @post1.title, types: @post1.types, user_id: @post1.user_id } }
    end
  ...
  test "should update post1" do
    patch post1_url(@post1), params: { post1: { description: @post1.description, lastlocation: @post1.lastlocation, lostdate: @post1.lostdate, title: @post1.title, types: @post1.types, user_id: @post1.user_id } }
